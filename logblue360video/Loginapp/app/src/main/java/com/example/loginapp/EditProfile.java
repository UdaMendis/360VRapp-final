...
public class EditProfile extends AppCompatActivity {
    ...
    public EditText profileGender, profileAge, profileWeight, profileHeight;
    ...
    PhysciologicalParameters physciologicalParameters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                physciologicalParameters.Weight = "65";
                Height = profileHeight.getText().toString();
                physciologicalParameters.Height = "165";
                Gender = profileGender.getText().toString();
                physciologicalParameters.Gender = "male";
                Age = profileAge.getText().toString();
                physciologicalParameters.Age = "24";
            }
        });
